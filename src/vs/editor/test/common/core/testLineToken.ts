...
import { ColorId, TokenMetadata, ITokenPresentation, StandardTokenType } from '../../../../editor/common/language/encodedTokenAttributes.js';
import { ILanguageIdCodec } from '../../../../editor/common/language/languages.js';
