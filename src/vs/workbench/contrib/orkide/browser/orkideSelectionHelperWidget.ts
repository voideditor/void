...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	...
	constructor(
		...
		@IOrkideSettingsService private readonly _orkideSettingsService: IOrkideSettingsService
	) {
		super();
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		// rerender
		const enabled = this._orkideSettingsService.state.globalSettings.showInlineSuggestions
