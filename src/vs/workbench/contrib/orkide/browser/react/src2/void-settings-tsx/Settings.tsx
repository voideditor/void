...
const ButtonLeftTextRightOption = ({ text, leftButton }: {text: string;leftButton?: React.ReactNode;}) => {
  ...
  return <div className="void-flex void-items-center void-text-void-fg-3 void-px-3 void-py-0.5 void-rounded-sm void-overflow-hidden void-gap-2">
    ...
    <button
      ...
      onClick={() => {
        ...
        metricsService.capture('Click', { providerName, action: 'Refresh Models' });
				...
				{justFinished === 'finished' ? <Check className="void-stroke-green-500 void-size-3" /> :
...
export const AnimatedCheckmarkButton = ({ text, className }: {text?: string;className?: string;}) => {
  ...
  return <div
    className={`void-flex void-items-center void-gap-1.5 void-w-fit ${
    className ? className : `void-px-2 void-py-0.5 void-text-xs void-text-zinc-900 void-bg-zinc-100 void-rounded-sm`} `}>


		<svg className="void-size-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path
        d="M5 13l4 4L19 7"
        stroke="currentColor"
        strokeWidth="2"
...
const ConfirmButton = ({ children, onConfirm, className }: {children: React.ReactNode;onConfirm: () => void;className?: string;}) => {
  ...
  return (
    <div ref={ref} className={`void-inline-block`}>
      ...
      mouseDownInsideModal.current = false;
        ...
        onMouseDown={(e) => {
          ...
          e.stopPropagation();
				...
				<div className="void-flex void-justify-between void-items-center void-mb-4">
					<h3 className="void-text-lg void-font-medium">
            ...
            className="void-text-void-fg-3 hover:void-text-void-fg-1">
						...
						<X className="void-size-5" />
					</button>
				</div>

				{/* Display model recognition status */}
				<div className="void-text-sm void-text-void-fg-3 void-mb-4">
          ...
          `Void recognizes ${modelName} ("${recognizedModelName}").`}
				...
				<div className="void-flex void-items-center void-gap-2 void-mb-4">
					...
					<span className="void-text-void-fg-3 void-text-sm">Override model defaults</span>
				</div>

				{/* Informational link */}
				{overrideEnabled && <div className="void-text-sm void-text-void-fg-3 void-mb-4">
          ...
          readOnly={!overrideEnabled} />
				...
				{errorMsg &&
        <div className="void-text-red-500 void-mt-2 void-text-sm">{errorMsg}</div>
        }


				<div className="void-flex void-justify-end void-gap-2 void-mt-4">
					<VoidButtonBgDarken onClick={onClose} className="void-px-3 void-py-1">
						Cancel
					</VoidButtonBgDarken>
					<VoidButtonBgDarken
            onClick={onSave}
...
export const ModelDump = ({ filteredProviders }: {filteredProviders?: ProviderName[];}) => {
  ...
  return <div className="">
      ...
      <Asterisk size={14} className="void-inline-block void-align-text-top void-brightness-115 void-stroke-[2] void-text-[#0e70c0]" data-tooltip-id='void-tooltip' data-tooltip-place='right' data-tooltip-content='Detected locally' /> :
      type === 'custom' ?
      <Asterisk size={14} className="void-inline-block void-align-text-top void-brightness-115 void-stroke-[2] void-text-[#0e70c0]" data-tooltip-id='void-tooltip' data-tooltip-place='right' data-tooltip-content='Custom model' /> :
      undefined;
      ...
      className={`void-flex void-items-center void-justify-between void-gap-4 hover:void-bg-black/10 dark:hover:void-bg-gray-300/10 void-py-1 void-px-3 void-rounded-sm void-overflow-hidden void-cursor-default void-truncate void-group `}>
				...
				<div className={`void-flex void-flex-grow void-items-center void-gap-4`}>
					<span className="void-w-full void-max-w-32">{isNewProviderName ? providerTitle : ''}</span>
					<span className="void-w-fit void-max-w-[400px] void-truncate">{modelName}</span>
				</div>

				{/* right part is anything that fits */}
				<div className="void-flex void-items-center void-gap-2 void-w-fit">
          ...
          <div className="void-w-5 void-flex void-items-center void-justify-center">
              ...
              className={`${hasOverrides ? "" : "void-opacity-0 group-hover:void-opacity-100"} void-transition-opacity`}>
								...
								<Plus size={12} className="void-text-void-fg-3 void-opacity-50" />
							</button>
						</div>
          }
            ...
            data-tooltip-content={tooltipName} />
              ...
              className={`${hasOverrides ? "" : "void-opacity-0 group-hover:void-opacity-100"} void-transition-opacity`}>
							...
							<X size={12} className="void-text-void-fg-3 void-opacity-50" />
						</button>}
					</div>
				</div>
			</div>;
		...
		{/* Add Model Section */}
		{showCheckmark ?
    <div className="void-mt-4">
				<AnimatedCheckmarkButton text='Added' className="void-bg-[#0e70c0] void-text-white void-px-3 void-py-1 void-rounded-sm" />
			</div> :
    isAddModelOpen ?
    <div className="void-mt-4">
				<form className="void-flex void-items-center void-gap-2">
          ...
          className="void-text-void-fg-4">
						...
						<X className="void-size-4" />
					</button>
				</form>

				{errorString &&
      <div className="void-text-red-500 void-truncate void-whitespace-nowrap void-mt-1">
						{errorString}
					</div>
      }
			</div> :
...
const ProviderSetting = ({ providerName, settingName, subTextMd }: {providerName: ProviderName;settingName: SettingName;subTextMd: React.ReactNode;}) => {
  ...
  return <ErrorBoundary>
        ...
        compact={true} />
			...
			{!subTextMd ? null : <div className="void-py-1 void-px-3 void-opacity-50 void-text-sm">
				{subTextMd}
			</div>}
		</div>
	</ErrorBoundary>;
...
export const SettingsForProvider = ({ providerName, showProviderTitle, showProviderSuggestions }: {providerName: ProviderName;showProviderTitle: boolean;showProviderSuggestions: boolean;}) => {
  ...
  return <div>
		...
		<div className="void-flex void-items-center void-w-full void-gap-4">
			{showProviderTitle && <h3 className="void-text-xl void-truncate">{providerTitle}</h3>}
      ...
      providerName === 'ollama' ?
      <WarningBox className="void-pl-2 void-mb-4" text={`Please install an Ollama model. We'll auto-detect it.`} /> :
      <WarningBox className="void-pl-2 void-mb-4" text={`Please add a model for ${providerTitle} (Models section).`} /> :
      null}
		</div>
	</div>;
};
...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: {sayWeAutoDetect?: boolean;}) => {
  return <div className="prose-p:void-my-0 prose-ol:void-list-decimal prose-p:void-py-0 prose-ol:void-my-0 prose-ol:void-py-0 prose-span:void-my-0 prose-span:void-py-0 void-text-void-fg-3 void-text-sm void-list-decimal void-select-text">
		<div className=""><ChatMarkdownRender string={`Ollama Setup Instructions`} chatMessageLocation={undefined} /></div>
		<div className=" void-pl-6"><ChatMarkdownRender string={`1. Download [Ollama](https://ollama.com/download).`} chatMessageLocation={undefined} /></div>
		<div className=" void-pl-6"><ChatMarkdownRender string={`2. Open your terminal.`} chatMessageLocation={undefined} /></div>
		<div
      ...
      data-tooltip-id='void-tooltip-ollama-settings'>
		...
		{sayWeAutoDetect && <div className=" void-pl-6"><ChatMarkdownRender string={`Void automatically detects locally running models and enables them.`} chatMessageLocation={undefined} /></div>}
	</div>;
};
...
export const ToolApprovalTypeSwitch = ({ approvalType, size, desc }: {approvalType: ToolApprovalType;size: "xxs" | "xs" | "sm" | "sm+" | "md";desc: string;}) => {
  ...
  return <>
      ...
      onChange={(newVal) => onToggleAutoApprove(approvalType, newVal)} />
		...
		<span className="void-text-void-fg-3 void-text-xs">{desc}</span>
	</>;
};
...
export const OneClickSwitchButton = ({ fromEditor = 'VS Code', className = '' }: {fromEditor?: TransferEditorType;className?: string;}) => {
  ...
  return <>
		<VoidButtonBgDarken className={`void-max-w-48 void-p-4 ${className}`} disabled={transferState.type !== 'done'} onClick={onClick}>
			{transferState.type === 'done' ? `Transfer from ${fromEditor}` :
      transferState.type === 'loading' ? <span className="void-text-nowrap void-flex void-flex-nowrap">Transferring<IconLoading /></span> :
      transferState.type === 'justfinished' ? <AnimatedCheckmarkButton text='Settings Transferred' className="void-bg-none" /> :
      null
      }
		</VoidButtonBgDarken>
...
const MCPServerComponent = ({ name, server }: {name: string;server: MCPServer;}) => {
  ...
  return (
    <div className="void-border void-border-void-border-2 void-bg-void-bg-1 void-py-3 void-px-4 void-rounded-sm void-my-2">
			<div className="void-flex void-items-center void-justify-between">
				{/* Left side - status and name */}
				<div className="void-flex void-items-center void-gap-2">
					{/* Status indicator */}
					<div className={`void-w-2 void-h-2 void-rounded-full ${
          server.status === 'success' ? "void-bg-green-500" :
          server.status === 'error' ? "void-bg-red-500" :
          server.status === 'loading' ? "void-bg-yellow-500" :
          server.status === 'offline' ? "void-bg-void-fg-3" : ""} `}>

          </div>

					{/* Server name */}
					<div className="void-text-sm void-font-medium void-text-void-fg-1">{name}</div>
				</div>
      ...
      <div className="void-mt-3">
					<div className="void-flex void-flex-wrap void-gap-2 void-max-h-32 void-overflow-y-auto">
          ...
          <span className="void-text-xs void-text-void-fg-3">No tools available</span>
          }
					</div>
				</div>
      }
			...
			{isOn && server.command &&
      <div className="void-mt-3">
					<div className="void-text-xs void-text-void-fg-3 void-mb-1">Command:</div>
					<div className="void-px-2 void-py-1 void-bg-void-bg-2 void-text-xs void-font-mono void-overflow-x-auto void-whitespace-nowrap void-text-void-fg-2 void-rounded-sm">
						{server.command}
					</div>
				</div>
      }
...
const MCPServersList = () => {
  ...
  if (mcpServiceState.error) {
    content = <div className="void-text-void-fg-3 void-text-sm void-mt-2">
  ...
  return <div className="void-my-2">{content}</div>;
};
...
export const Settings = () => {
  ...
  return (
    <div className={`void-scope ${isDark ? "void-dark" : ""}`} style={{ height: '100%', width: '100%', overflow: 'auto' }}>
			<div className="void-flex void-flex-col md:void-flex-row void-w-full void-gap-6 void-max-w-[900px] void-mx-auto void-mb-32" style={{ minHeight: '80vh' }}>
				{/* ──────────────  SIDEBAR  ────────────── */}

				<aside className="md:void-w-1/4 void-w-full void-p-6 void-shrink-0">
					{/* vertical tab list */}
					<div className="void-flex void-flex-col void-gap-2 void-mt-12">
            ...
            <button
              ...
              className={` void-py-2 void-px-4 void-rounded-md void-text-left void-transition-all void-duration-200 ${

              selectedSection === tab ? "void-bg-[#0e70c0]/80 void-text-white void-font-medium void-shadow-sm" : "void-bg-void-bg-2 hover:void-bg-void-bg-2/80 void-text-void-fg-1"} `}>
				...
				{/* ───────────── MAIN PANE ───────────── */}
				<main className="void-flex-1 void-p-6 void-select-none">



					<div className="void-max-w-3xl">

						<h1 className="void-text-2xl void-w-full">{`Void's Settings`}</h1>

						<div className="void-w-full void-h-[1px] void-my-2" />
						...
						<div className="void-flex void-flex-col void-gap-12">
							{/* Models section (formerly FeaturesTab) */}
							<div className={shouldShowTab('models') ? `` : "void-hidden"}>
								<ErrorBoundary>
									<h2 className={`void-text-3xl void-mb-2`}>Models</h2>
									<ModelDump />
									<div className="void-w-full void-h-[1px] void-my-4" />
							...
							<div className={shouldShowTab('localProviders') ? `` : "void-hidden"}>
								<ErrorBoundary>
									...
									<div className="void-opacity-80 void-mb-4">
							...
							<div className={shouldShowTab('providers') ? `` : "void-hidden"}>
								<ErrorBoundary>
									<h2 className={`void-text-3xl void-mb-2`}>Main Providers</h2>
							...
							<div className={shouldShowTab('featureOptions') ? `` : "void-hidden"}>
								<ErrorBoundary>
									<h2 className={`void-text-3xl void-mb-2`}>Feature Options</h2>

									<div className="void-flex void-flex-col void-gap-y-8 void-my-4">
										<ErrorBoundary>
											{/* FIM */}
											<div>
												<h4 className={`void-text-base`}>{displayInfoOfFeatureName('Autocomplete')}</h4>
												<div className="void-text-sm void-text-void-fg-3 void-mt-1">
													<span>
														Experimental.{' '}
													</span>
													<span
                            ...
                            data-tooltip-class-name='void-max-w-[20px]'>
												...
												<div className="void-my-2">
													{/* Enable Switch */}
													<ErrorBoundary>
														<div className="void-flex void-items-center void-gap-x-2 void-my-2">
															<VoidSwitch
                                size='xs'
                                value={settingsState.globalSettings.enableAutocomplete}
                                onChange={(newVal) => voidSettingsService.setGlobalSetting('enableAutocomplete', newVal)} />

															<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{settingsState.globalSettings.enableAutocomplete ? 'Enabled' : 'Disabled'}</span>
														</div>
													</ErrorBoundary>

													{/* Model Dropdown */}
													<ErrorBoundary>
														<div className={`void-my-2 ${!settingsState.globalSettings.enableAutocomplete ? "void-hidden" : ""}`}>
															<ModelDropdown featureName={'Autocomplete'} className="void-text-xs void-text-void-fg-3 void-bg-void-bg-1 void-border void-border-void-border-1 void-rounded void-p-0.5 void-px-1" />
														</div>
													</ErrorBoundary>
										...
										<ErrorBoundary>
											...
											<div className="void-w-full">
												<h4 className={`void-text-base`}>{displayInfoOfFeatureName('Apply')}</h4>
												<div className="void-text-sm void-text-void-fg-3 void-mt-1">Settings that control the behavior of the Apply button.</div>
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('syncApplyToChat', newVal)} />
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{settingsState.globalSettings.syncApplyToChat ? 'Same as Chat model' : 'Different model'}</span>
													</div>

													{/* Model Dropdown */}
													<div className={`void-my-2 ${settingsState.globalSettings.syncApplyToChat ? "void-hidden" : ""}`}>
														<ModelDropdown featureName={'Apply'} className="void-text-xs void-text-void-fg-3 void-bg-void-bg-1 void-border void-border-void-border-1 void-rounded void-p-0.5 void-px-1" />
													</div>
												</div>
										...
										{/* Tools Section */}
										<div>
											<h4 className={`void-text-base`}>Tools</h4>
											<div className="void-text-sm void-text-void-fg-3 void-mt-1">{`Tools are functions that LLMs can call. Some tools require user approval.`}</div>

											<div className="void-my-2">
												{/* Auto Accept Switch */}
												<ErrorBoundary>
													{[...toolApprovalTypes].map((approvalType) => {
                            return <div key={approvalType} className="void-flex void-items-center void-gap-x-2 void-my-2">
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('includeToolLintErrors', newVal)} />
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{settingsState.globalSettings.includeToolLintErrors ? 'Fix lint errors' : `Fix lint errors`}</span>
													</div>
												</ErrorBoundary>
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('autoAcceptLLMChanges', newVal)} />
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">Auto-accept LLM changes</span>
													</div>
												</ErrorBoundary>
											</div>
										</div>
										...
										<div className="void-w-full">
											<h4 className={`void-text-base`}>Editor</h4>
											<div className="void-text-sm void-text-void-fg-3 void-mt-1">{`Settings that control the visibility of Void suggestions in the code editor.`}</div>
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('showInlineSuggestions', newVal)} />
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{settingsState.globalSettings.showInlineSuggestions ? 'Show suggestions on select' : 'Show suggestions on select'}</span>
													</div>
												</ErrorBoundary>
											</div>
										</div>
										...
										<ErrorBoundary>
											...
											<div className="void-w-full">
												<h4 className={`void-text-base`}>{displayInfoOfFeatureName('SCM')}</h4>
												<div className="void-text-sm void-text-void-fg-3 void-mt-1">Settings that control the behavior of the commit message generator.</div>
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('syncSCMToChat', newVal)} />
														...
														<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{settingsState.globalSettings.syncSCMToChat ? 'Same as Chat model' : 'Different model'}</span>
													</div>

													{/* Model Dropdown */}
													<div className={`void-my-2 ${settingsState.globalSettings.syncSCMToChat ? "void-hidden" : ""}`}>
														<ModelDropdown featureName={'SCM'} className="void-text-xs void-text-void-fg-3 void-bg-void-bg-1 void-border void-border-void-border-1 void-rounded void-p-0.5 void-px-1" />
													</div>
												</div>
							...
							{/* General section */}
							<div className={`${shouldShowTab('general') ? `` : "void-hidden"} void-flex void-flex-col void-gap-12`}>
								{/* One-Click Switch section */}
								<div>
									<ErrorBoundary>
										<h2 className="void-text-3xl void-mb-2">One-Click Switch</h2>
										<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer your editor settings into Void.`}</h4>

										<div className="void-flex void-flex-col void-gap-2">
											<OneClickSwitchButton className="void-w-48" fromEditor="VS Code" />
											<OneClickSwitchButton className="void-w-48" fromEditor="Cursor" />
											<OneClickSwitchButton className="void-w-48" fromEditor="Windsurf" />
										</div>
									</ErrorBoundary>
								</div>
								...
								<div>
									<h2 className="void-text-3xl void-mb-2">Import/Export</h2>
									<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer Void's settings and chats in and out of Void.`}</h4>
									<div className="void-flex void-flex-col void-gap-8">
										{/* Settings Subcategory */}
										<div className="void-flex void-flex-col void-gap-2 void-max-w-48 void-w-full">
											<input key={2 * s} ref={fileInputSettingsRef} type='file' accept='.json' className="void-hidden" onChange={handleUpload('Settings')} />
											<VoidButtonBgDarken className="void-px-4 void-py-1 void-w-full" onClick={() => {fileInputSettingsRef.current?.click();}}>
												Import Settings
											</VoidButtonBgDarken>
											<VoidButtonBgDarken className="void-px-4 void-py-1 void-w-full" onClick={() => onDownload('Settings')}>
												Export Settings
											</VoidButtonBgDarken>
											<ConfirmButton className="void-px-4 void-py-1 void-w-full" onConfirm={() => {voidSettingsService.resetState();}}>
												Reset Settings
											</ConfirmButton>
										</div>
										...
										{/* Chats Subcategory */}
										<div className="void-flex void-flex-col void-gap-2 void-max-w-48 void-w-full">
											<input key={2 * s + 1} ref={fileInputChatsRef} type='file' accept='.json' className="void-hidden" onChange={handleUpload('Chats')} />
											<VoidButtonBgDarken className="void-px-4 void-py-1 void-w-full" onClick={() => {fileInputChatsRef.current?.click();}}>
												Import Chats
											</VoidButtonBgDarken>
											<VoidButtonBgDarken className="void-px-4 void-py-1 void-w-full" onClick={() => onDownload('Chats')}>
												Export Chats
											</VoidButtonBgDarken>
											<ConfirmButton className="void-px-4 void-py-1 void-w-full" onConfirm={() => {chatThreadsService.resetState();}}>
												Reset Chats
											</ConfirmButton>
										</div>
									</div>
								...
								<div>
									...
									<h4 className={`void-text-void-fg-3 void-mb-4`}>{`IDE settings, keyboard settings, and theme customization.`}</h4>

									<ErrorBoundary>
										<div className="void-flex void-flex-col void-gap-2 void-justify-center void-max-w-48 void-w-full">
											<VoidButtonBgDarken className="void-px-4 void-py-1" onClick={() => {commandService.executeCommand('workbench.action.openSettings');}}>
												General Settings
											</VoidButtonBgDarken>
											<VoidButtonBgDarken className="void-px-4 void-py-1" onClick={() => {commandService.executeCommand('workbench.action.openGlobalKeybindings');}}>
												Keyboard Settings
											</VoidButtonBgDarken>
											<VoidButtonBgDarken className="void-px-4 void-py-1" onClick={() => {commandService.executeCommand('workbench.action.selectTheme');}}>
												Theme Settings
											</VoidButtonBgDarken>
											<VoidButtonBgDarken className="void-px-4 void-py-1" onClick={() => {nativeHostService.showItemInFolder(environmentService.logsHome.fsPath);}}>
												Open Logs
											</VoidButtonBgDarken>
										</div>
									</ErrorBoundary>
								...
								{/* Metrics section */}
								<div className="void-max-w-[600px]">
									<h2 className={`void-text-3xl void-mb-2`}>Metrics</h2>
									<h4 className={`void-text-void-fg-3 void-mb-4`}>Very basic anonymous usage tracking helps us keep Void running smoothly. You may opt out below. Regardless of this setting, Void never sees your code, messages, or API keys.</h4>
                          ...
                          onChange={(newVal) => {
                            ...
                            metricsService.capture(`Set metrics opt-out to ${newVal}`, {}); // this only fires if it's enabled, so it's fine to have here
												...
												<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">{'Opt-out (requires restart)'}</span>
											</div>
										</ErrorBoundary>
									</div>
								</div>
...
Alternatively, place a \`.voidrules\` file in the root of your workspace.
								`} chatMessageLocation={undefined} />
									...
									<div className="void-my-4">
										<ErrorBoundary>
											<div className="void-flex void-items-center void-gap-x-2">
												<VoidSwitch
                          size='xs'
                          ...
                          onChange={(newValue) => {
                            voidSettingsService.setGlobalSetting('disableSystemMessage', newValue);
												...
												<span className="void-text-void-fg-3 void-text-xs void-pointer-events-none">
													{'Disable system message'}
												</span>
											</div>
										</ErrorBoundary>
										<div className="void-text-void-fg-3 void-text-xs void-mt-1">
							...
							{/* MCP section */}
							<div className={shouldShowTab('mcp') ? `` : "void-hidden"}>
								<ErrorBoundary>
									<h2 className="void-text-3xl void-mb-2">MCP</h2>
									<h4 className={`void-text-void-fg-3 void-mb-4`}>
										<ChatMarkdownRender inPTag={true} string={`
Use Model Context Protocol to provide Agent mode with more tools.
							`} chatMessageLocation={undefined} />
									...
									<div className="void-my-2">
										<VoidButtonBgDarken className="void-px-4 void-py-1 void-w-full void-max-w-48" onClick={async () => {await mcpService.revealMCPConfigFile();}}>
											Add MCP Server
										</VoidButtonBgDarken>
									</div>
