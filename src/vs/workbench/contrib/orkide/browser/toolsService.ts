...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IOrkideModelService orkideModelService: IOrkideModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IOrkideCommandBarService private readonly commandBarService: IOrkideCommandBarService,
		...
		this.callTool = {
			read_file: async ({ uri, startLine, endLine, pageNumber }) => {
				await orkideModelService.initializeModel(uri)
				const { model } = await orkideModelService.getModelSafe(uri)
		...
		this.stringOfResult = {
			...
			search_in_file: (params, result) => {
				const { model } = orkideModelService.getModel(params.uri)
			...
			edit_file: (params, result) => {
				const lintErrsString = (
					this.orkideSettingsService.state.globalSettings.includeToolLintErrors ?
