...
export interface IOrkideModelService {
...
export const IOrkideModelService = createDecorator<IOrkideModelService>('voidVoidModelService');

class OrkideModelService extends Disposable implements IOrkideModelService {
...
registerSingleton(IOrkideModelService, VoidModelService, InstantiationType.Eager);
