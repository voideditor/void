...
import { ORKIDE_SETTINGS_STORAGE_KEY } from './storageKeys.js';
import { defaultSettingsOfProvider, FeatureName, ProviderName, ModelSelectionOfFeature, SettingsOfProvider, SettingName, providerNames, ModelSelection, modelSelectionsEqual, featureNames, VoidStatefulModelInfo, GlobalSettings, GlobalSettingName, defaultGlobalSettings, ModelSelectionOptions, OptionsOfModelSelection, ChatMode, OverridesOfModel, defaultOverridesOfModel, MCPUserStateOfName as MCPUserStateOfName, MCPUserState } from './orkideSettingsTypes.js';
...
export interface IOrkideSettingsService {
...
export const IOrkideSettingsService = createDecorator<IOrkideSettingsService>('OrkideSettingsService');
class OrkideSettingsService extends Disposable implements IOrkideSettingsService {
	...
	private async _readState(): Promise<VoidSettingsState> {
		const encryptedState = this._storageService.get(ORKIDE_SETTINGS_STORAGE_KEY, StorageScope.APPLICATION)
	...
	private async _storeState() {
		...
		this._storageService.store(ORKIDE_SETTINGS_STORAGE_KEY, encryptedState, StorageScope.APPLICATION, StorageTarget.USER);
	}
...
registerSingleton(IOrkideSettingsService, VoidSettingsService, InstantiationType.Eager);
