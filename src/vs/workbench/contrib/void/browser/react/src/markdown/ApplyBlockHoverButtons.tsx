...
export const ApplyButtonsHTML = ({
	...
	const onClickSubmit = useCallback(async () => {
		...
		if (language === "bash" || language === "shellscript") {
			const terminal = terminalService.activeInstance;
			if (terminal) {
				await terminal.sendText(codeStr, true);
				metricsService.capture("Apply Code to Terminal", {
...
export const BlockCodeApplyWrapper = ({
	...
	return (
		<div className="border border-void-border-3 rounded overflow-hidden bg-void-bg-3 my-1">
			{/* header */}
