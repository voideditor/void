...
const UserMessageComponent = ({
    ...
    `}
        ...
        `}
			...
			<div className="absolute -top-1 -right-1 translate-x-0 -translate-y-0 z-1">
				<EditSymbol
					size={18}
					className={`
                    cursor-pointer
...
const InvalidTool = ({
	...
	const isError = true;
	const componentParams: ToolHeaderParams = { title, desc1, isError };
...
const CanceledTool = ({
	...
	const componentParams: ToolHeaderParams = { title, desc1, isRejected };
	return <ToolHeaderWrapper {...componentParams} />;
};
