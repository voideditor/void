...
import {
	...
	FeatureName,
	hasDownloadButtonsOnModelsProviderNames,
...
import {
	TransferEditorType,
	TransferFilesInfo,
} from "../../../extensionTransferTypes.js";
...
const SimpleModelSettingsDialog = ({
	...
	return (
		...
		>
			{/* MODAL */}
			<div
				className="bg-void-bg-1 rounded-sm p-4 max-w-xl w-full shadow-xl overflow-y-auto max-h-[90vh]"
...
export const OllamaSetupInstructions = ({
	...
	return (
		<div className="prose-p:my-0 prose-ol:list-decimal prose-p:py-0 prose-ol:my-0 prose-ol:py-0 prose-span:my-0 prose-span:py-0 text-void-fg-3 text-sm list-decimal select-text">
			<div className="">
				<ChatMarkdownRender
					string={`Ollama Setup Instructions`}
					chatMessageLocation={undefined}
				/>
			</div>
			<div className=" pl-6">
				<ChatMarkdownRender
					string={`1. Download [Ollama](https://ollama.com/download).`}
					chatMessageLocation={undefined}
				/>
			</div>
			<div className=" pl-6">
				<ChatMarkdownRender
					string={`2. Open your terminal.`}
					chatMessageLocation={undefined}
				/>
			</div>
			<div
			...
			>
				<ChatMarkdownRender
					string={`3. Run \`ollama pull your_model\` to install a model.`}
					chatMessageLocation={undefined}
				/>
			</div>
			{sayWeAutoDetect && (
				...
				<main className="flex-1 p-6 select-none">
					<div className="max-w-3xl">
						...
						<div className="flex flex-col gap-12">
										...
										<ErrorBoundary>
											...
											<div>
												...
												<div className="my-2">
													...
													<ErrorBoundary>
														<div
															className={`my-2 ${!settingsState.globalSettings.enableAutocomplete ? "hidden" : ""}`}
														>
															<ModelDropdown
										...
										<ErrorBoundary>
											<div className="w-full">
												...
												<div className="my-2">
													...
													{/* Model Dropdown */}
													<div
														className={`my-2 ${settingsState.globalSettings.syncApplyToChat ? "hidden" : ""}`}
													>
														<ModelDropdown
															featureName={"Apply"}
															className="text-xs text-void-fg-3 bg-void-bg-1 border border-void-border-1 rounded p-0.5 px-1"
										...
										<ErrorBoundary>
											<div className="w-full">
												...
												<div className="my-2">
													...
													{/* Model Dropdown */}
													<div
														className={`my-2 ${settingsState.globalSettings.syncSCMToChat ? "hidden" : ""}`}
													>
														<ModelDropdown
															featureName={"SCM"}
															className="text-xs text-void-fg-3 bg-void-bg-1 border border-void-border-1 rounded p-0.5 px-1"
							...
							{/* General section */}
							<div
								className={`${shouldShowTab("general") ? `` : "hidden"} flex flex-col gap-12`}
							>
